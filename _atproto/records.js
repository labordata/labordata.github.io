// Syncs the Notes on Labor Data blog to the ATmosphere as Standard.Site records.
//
...
const SITE_URL = "https://notes.labordata.bunkum.us/";
const PUBLICATION_RKEY = "labordata-notes"; // stable, readable publication key
...
const THEME = {
  ...
  background: { $type: "site.standard.theme.color#rgb", r: 250, g: 250, b: 247 }, // #fafaf7
  foreground: { $type: "site.standard.theme.color#rgb", r: 21, g: 17, b: 13 }, // #15110d
  accent: { $type: "site.standard.theme.color#rgb", r: 192, g: 2, b: 62 }, // #c0023e
...
const syncPublication = async (agent, publicationUri) => {
  ...
  const base = {
    $type: PUB_COLLECTION,
    url: SITE_URL,
    name: "Notes on Labor Data",
    description: "Notes on labor data from the Labordata project.",
    basicTheme: THEME,
